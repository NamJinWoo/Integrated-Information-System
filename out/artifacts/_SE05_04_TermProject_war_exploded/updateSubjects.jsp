...
<%
    ...
    Subject subject = new Subject(lectureId, lectureName, profName, classroomNum, classTime, gradeValue, eduYear, maxStudents, lectureKind, lectureMajor, lecturePlan);

    SubDAO.updateSubjectInfo(subject);
%>
<script>
    alert("수정되었습니다.");
